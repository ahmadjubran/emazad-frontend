...
import { selectCount, selectItems } from "../../store/features/itemSlicer";
...
export default function ItemsList() {
  ...
  useEffect(() => {
    getItems(dispatch, 0, "active", category ? category : null, subCategory ? subCategory : null);
  }, [dispatch]);
  ...
  const renderStatus = (status) => {
    return (
      <Button
        color={statusState === status ? "blue.500" : "gray.500"}
        p="0"
        bg="transparent"
        ...
        onClick={() => {
          getItems(dispatch, 0, status, localStorage.getItem("category"), localStorage.getItem("subCategory"));
      ...
      <Flex justifyContent="center" alignItems="center" gap="2" mt="4">
        {pagesArray.map((page) => (
          <Button
            ...
            color={page === currentPage ? "white" : "gray.500"}
    ...
    <Box>
        ...
        <Flex textTransform="uppercase" alignItems="center" gap="2" color="gray.500" fontSize="md">
          <Text
            ...
            onClick={() => {
              ...
              getItems(dispatch, 0, "active", category);
              setSubCategory("All");
              setStatusState("active");
            }}
            cursor="pointer"
      ...
      <Grid templateColumns={{ base: "repeat(1, 1fr)", md: "repeat(2, 1fr)", lg: "repeat(3, 1fr)" }} gap={6}>
        {items.length > 0 ? (
          ...
          <>
            <Box></Box>
            <Box w="100%" h="30rem" display="flex" alignItems="center" justifyContent="center">
