        ...
        <Flex direction="column" align="center" justify="center" position="relative" h={{ md: "30rem", lg: "40rem" }}>
          ...
          <Box zIndex="2" w="70%" textAlign="center">
            ...
            <Text color="gray.200" fontSize="md" mixW="60%" textAlign="center" letterSpacing={1.2} lineHeight={1.8}>
              eMazad is an online auction website that allows users to bid on and sell a wide variety of products in a
              safe and secure environment, it is easy to use and has a simple interface. It hosts a huge number of
              auctions in real time and you can bid on any item you want within a minutes.
            </Text>
          </Box>
        </Flex>
              ...
              >
                ...
                <Box px={{ base: "4", md: "8" }} py="6" mb="10">
                  ...
                  >
                    ...
                    <Box p="6" flex="1 1 auto">
                      <Text color={useColorModeValue("gray.600", "gray.400")} fontSize="md" textAlign="center">
                        Sign up and starting bidding right now! See how it's easy to use?
                      </Text>
                    </Box>
                  </Box>
                </Box>
      ...
      <Center py={12}>
        <Grid templateColumns={{ sm: "repeat(1, 1fr)", md: "repeat(2, 1fr)", lg: "repeat(3,1fr)" }} gap={20}>
          ...
          >
            ...
            >
              <Image rounded={"lg"} height={250} width={250} objectFit={"cover"} src={Saeed} />
            </Box>
          ...
          >
            ...
            >
              <Image rounded={"lg"} height={250} width={250} objectFit={"cover"} src={Yaseer} />
            </Box>
            <Stack pt={10} align={"center"} gap="3" mb="3">
              <Heading fontSize={"2xl"} fontFamily={"body"} fontWeight={500}>
                Yasser Odat
          ...
          >
            ...
            >
              <Image rounded={"lg"} height={250} width={250} objectFit={"cover"} src={Qais} />
            </Box>
            <Stack pt={10} align={"center"} gap="3" mb="3">
              <Heading fontSize={"2xl"} fontFamily={"body"} fontWeight={500}>
                Qais Alsgher
          ...
          >
            ...
            >
              <Image rounded={"lg"} height={250} width={250} objectFit={"cover"} src={Omar} />
            </Box>
            <Stack pt={10} align={"center"} gap="3" mb="3">
              <Heading fontSize={"2xl"} fontFamily={"body"} fontWeight={500}>
                Omar Qattam
          ...
          >
            ...
            >
              <Image rounded={"lg"} height={250} width={250} objectFit={"cover"} src={Feras} />
            </Box>
