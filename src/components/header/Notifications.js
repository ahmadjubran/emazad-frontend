...
import {IconButton, useDisclosure, Drawer, DrawerOverlay, DrawerContent, DrawerHeader, DrawerBody, DrawerCloseButton, Box} from '@chakra-ui/react';
        ...
        <DrawerContent>
            ...
            <DrawerBody>
                {notifications.map((notification) => (
                    ...
                    <Box bg={'#D7D7D9'} borderRadius={'10px'} margin={'8px'} textAlign={'center'}>{notification.notiMessage}</Box>
                    </div>
                ))}
                <DrawerCloseButton />
            </DrawerBody>
